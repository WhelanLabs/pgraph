// Whelanlabs: forked from BaseEdgeDocument
/*
 * DISCLAIMER
 *
...
public class Edge extends Node {
   ...
   private static final long serialVersionUID = -2884642265688611007L;
   ...
   public Edge(final String key, final String from, final String to) {
      super(key);
      this.from = from;
      this.to = to;
   }
   ...
   public String toString() {
      return "BaseDocument [documentRevision=" + revision + ", documentHandle=" + id + ", documentKey=" + key + ", from=" + from + ", to=" + to
