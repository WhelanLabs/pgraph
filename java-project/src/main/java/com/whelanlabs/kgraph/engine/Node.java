// Whelanlabs: forked from BaseDocument
/*
 * DISCLAIMER
 *
...
public class Node implements Serializable {
   ...
   private static final long serialVersionUID = -8027297456420014067L;
   ...
   public String toString() {
      return "BaseDocument [documentRevision=" + revision + ", documentHandle=" + id + ", documentKey=" + key + ", properties=" + properties + "]";
   }
