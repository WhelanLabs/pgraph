...
//   public void removeTablespace(String db_name) {
...
//               ArangoCollection c = _userDB.collection(collection.getName());
//               Long count = c.count().getCount();
//               // logger.info("Collection " + collection.getName() + " size is " + count);
//            }
//         }
      }
      setUp(_db_name);
